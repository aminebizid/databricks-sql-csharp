...
namespace HiveClient.Sql.ThriftApi.TCLService.TTypes
{
  ...
  public partial class TGetPrimaryKeysReq : TBase
  {
    ...
    public async global::System.Threading.Tasks.Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
    {
      ...
      try
      {
        var tmp393 = new TStruct("TGetPrimaryKeysReq");
    ...
    {
      if (that is not TGetPrimaryKeysReq other) return false;
    ...
    {
      var tmp395 = new StringBuilder("TGetPrimaryKeysReq(");
      int tmp396 = 0;
      if((SessionHandle != null) && __isset.sessionHandle)
      {
        if(0 < tmp396++) { tmp395.Append(", "); }
        tmp395.Append("SessionHandle: ");
        SessionHandle.ToString(tmp395);
      }
      if((CatalogName != null) && __isset.catalogName)
      {
        if(0 < tmp396++) { tmp395.Append(", "); }
        tmp395.Append("CatalogName: ");
        CatalogName.ToString(tmp395);
      }
      if((SchemaName != null) && __isset.schemaName)
      {
        if(0 < tmp396++) { tmp395.Append(", "); }
        tmp395.Append("SchemaName: ");
        SchemaName.ToString(tmp395);
      }
      if((TableName != null) && __isset.tableName)
      {
        if(0 < tmp396++) { tmp395.Append(", "); }
        tmp395.Append("TableName: ");
        TableName.ToString(tmp395);
      }
      if((GetDirectResults != null) && __isset.getDirectResults)
      {
        if(0 < tmp396++) { tmp395.Append(", "); }
        tmp395.Append("GetDirectResults: ");
        GetDirectResults.ToString(tmp395);
      }
      if(__isset.runAsync)
      {
        if(0 < tmp396++) { tmp395.Append(", "); }
        tmp395.Append("RunAsync: ");
        RunAsync.ToString(tmp395);
      }
      if((OperationId != null) && __isset.operationId)
      {
        if(0 < tmp396++) { tmp395.Append(", "); }
        tmp395.Append("OperationId: ");
        OperationId.ToString(tmp395);
      }
      if((SessionConf != null) && __isset.sessionConf)
      {
        if(0 < tmp396++) { tmp395.Append(", "); }
        tmp395.Append("SessionConf: ");
        SessionConf.ToString(tmp395);
      }
      tmp395.Append(')');
