...
namespace HiveClient.Sql.ThriftApi.TCLService.TTypes
{
  ...
  public partial class TColumnDesc : TBase
  {
    ...
    private global::HiveClient.Sql.ThriftApi.TCLService.TTypes.TTypeDesc? _typeDesc;
    ...
    public global::HiveClient.Sql.ThriftApi.TCLService.TTypes.TTypeDesc? TypeDesc
    {
      get
      {
        return _typeDesc;
        ...
        while (true)
        {
          ...
          switch (field.ID)
          {
            ...
            case 2:
              ...
              {
                TypeDesc = new global::HiveClient.Sql.ThriftApi.TCLService.TTypes.TTypeDesc();
