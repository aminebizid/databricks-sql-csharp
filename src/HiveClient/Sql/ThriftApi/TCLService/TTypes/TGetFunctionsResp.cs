...
namespace HiveClient.Sql.ThriftApi.TCLService.TTypes
{
  ...
  public partial class TGetFunctionsResp : TBase
  {
    ...
    public async global::System.Threading.Tasks.Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
    {
      ...
      try
      {
        var tmp389 = new TStruct("TGetFunctionsResp");
    ...
    {
      if (that is not TGetFunctionsResp other) return false;
    ...
    {
      var tmp391 = new StringBuilder("TGetFunctionsResp(");
      int tmp392 = 0;
      if((Status != null) && __isset.status)
      {
        if(0 < tmp392++) { tmp391.Append(", "); }
        tmp391.Append("Status: ");
        Status.ToString(tmp391);
      }
      if((OperationHandle != null) && __isset.operationHandle)
      {
        if(0 < tmp392++) { tmp391.Append(", "); }
        tmp391.Append("OperationHandle: ");
        OperationHandle.ToString(tmp391);
      }
      if((DirectResults != null) && __isset.directResults)
      {
        if(0 < tmp392++) { tmp391.Append(", "); }
        tmp391.Append("DirectResults: ");
        DirectResults.ToString(tmp391);
      }
      tmp391.Append(')');
