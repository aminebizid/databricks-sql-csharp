...
namespace HiveClient.Sql.ThriftApi.TCLService.TTypes
{
  ...
  public partial class TCloseOperationResp : TBase
  {
    ...
    public async global::System.Threading.Tasks.Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
    {
      ...
      try
      {
        var tmp429 = new TStruct("TCloseOperationResp");
    ...
    {
      if (that is not TCloseOperationResp other) return false;
    ...
    {
      var tmp431 = new StringBuilder("TCloseOperationResp(");
      int tmp432 = 0;
      if((Status != null) && __isset.status)
      {
        if(0 < tmp432++) { tmp431.Append(", "); }
        tmp431.Append("Status: ");
        Status.ToString(tmp431);
      }
      tmp431.Append(')');
