...
namespace HiveClient.Sql.ThriftApi.TCLService.TTypes
{
  ...
  public partial class TGetOperationStatusResp : TBase
  {
    ...
    private global::HiveClient.Sql.ThriftApi.TCLService.TTypes.TOperationState _operationState;
    ...
    private global::HiveClient.Sql.ThriftApi.TCLService.TTypes.TProgressUpdateResp? _progressUpdateResponse;
    ...
    /// </summary>
    public global::HiveClient.Sql.ThriftApi.TCLService.TTypes.TOperationState OperationState
    {
      get
      {
    ...
    public global::HiveClient.Sql.ThriftApi.TCLService.TTypes.TProgressUpdateResp? ProgressUpdateResponse
    {
      get
      {
        ...
        while (true)
        {
          ...
          switch (field.ID)
          {
            ...
            case 2:
              ...
              {
                OperationState = (global::HiveClient.Sql.ThriftApi.TCLService.TTypes.TOperationState)await iprot.ReadI32Async(cancellationToken);
              }
              else
              {
                await TProtocolUtil.SkipAsync(iprot, field.Type, cancellationToken);
            ...
            case 10:
              if (field.Type == TType.Struct)
              {
                ProgressUpdateResponse = new global::HiveClient.Sql.ThriftApi.TCLService.TTypes.TProgressUpdateResp();
