...
namespace HiveClient.Sql.ThriftApi.TCLService.TTypes
{
  ...
  public partial class TFetchResultsResp : TBase
  {
    ...
    private global::HiveClient.Sql.ThriftApi.TCLService.TTypes.TRowSet? _results;
    ...
    public global::HiveClient.Sql.ThriftApi.TCLService.TTypes.TRowSet? Results
    {
      get
      {
        return _results;
        ...
        while (true)
        {
          ...
          switch (field.ID)
          {
            ...
            case 3:
              if (field.Type == TType.Struct)
              {
                Results = new global::HiveClient.Sql.ThriftApi.TCLService.TTypes.TRowSet();
