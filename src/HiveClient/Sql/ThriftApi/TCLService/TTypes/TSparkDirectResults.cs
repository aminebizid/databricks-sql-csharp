...
namespace HiveClient.Sql.ThriftApi.TCLService.TTypes
{
  ...
  {
    private global::HiveClient.Sql.ThriftApi.TCLService.TTypes.TGetOperationStatusResp? _operationStatus;
    private global::HiveClient.Sql.ThriftApi.TCLService.TTypes.TGetResultSetMetadataResp? _resultSetMetadata;
    private global::HiveClient.Sql.ThriftApi.TCLService.TTypes.TFetchResultsResp? _resultSet;
    private global::HiveClient.Sql.ThriftApi.TCLService.TTypes.TCloseOperationResp? _closeOperation;

    public global::HiveClient.Sql.ThriftApi.TCLService.TTypes.TGetOperationStatusResp? OperationStatus
    {
      get
      {
    ...
    public global::HiveClient.Sql.ThriftApi.TCLService.TTypes.TGetResultSetMetadataResp? ResultSetMetadata
    {
      get
      {
    ...
    public global::HiveClient.Sql.ThriftApi.TCLService.TTypes.TFetchResultsResp? ResultSet
    {
      get
      {
        return _resultSet;
    ...
    public global::HiveClient.Sql.ThriftApi.TCLService.TTypes.TCloseOperationResp? CloseOperation
    {
      get
      {
        ...
        while (true)
        {
          ...
          switch (field.ID)
          {
            case 1:
              ...
              {
                OperationStatus = new global::HiveClient.Sql.ThriftApi.TCLService.TTypes.TGetOperationStatusResp();
            ...
            case 2:
              if (field.Type == TType.Struct)
              {
                ResultSetMetadata = new global::HiveClient.Sql.ThriftApi.TCLService.TTypes.TGetResultSetMetadataResp();
            ...
            case 3:
              if (field.Type == TType.Struct)
              {
                ResultSet = new global::HiveClient.Sql.ThriftApi.TCLService.TTypes.TFetchResultsResp();
            ...
            case 4:
              if (field.Type == TType.Struct)
              {
                CloseOperation = new global::HiveClient.Sql.ThriftApi.TCLService.TTypes.TCloseOperationResp();
