...
namespace HiveClient.Sql.ThriftApi.TCLService.TTypes
{
  ...
  public partial class TOpenSessionResp : TBase
  {
    ...
    private global::HiveClient.Sql.ThriftApi.TCLService.TTypes.TNamespace? _initialNamespace;
    private bool _canUseMultipleCatalogs;
    private List<global::HiveClient.Sql.ThriftApi.TCLService.TTypes.TGetInfoValue>? _getInfos;
    ...
    public global::HiveClient.Sql.ThriftApi.TCLService.TTypes.TNamespace? InitialNamespace
    {
      get
      {
    ...
    public List<global::HiveClient.Sql.ThriftApi.TCLService.TTypes.TGetInfoValue>? GetInfos
    {
      get
      {
        return _getInfos;
        ...
        while (true)
        {
          ...
          switch (field.ID)
          {
            ...
            case 1284:
              if (field.Type == TType.Struct)
              {
                InitialNamespace = new global::HiveClient.Sql.ThriftApi.TCLService.TTypes.TNamespace();
              ...
              {
                {
                  ...
                  GetInfos = new List<global::HiveClient.Sql.ThriftApi.TCLService.TTypes.TGetInfoValue>(_list279.Count);
                  for(int _i280 = 0; _i280 < _list279.Count; ++_i280)
                  {
                    global::HiveClient.Sql.ThriftApi.TCLService.TTypes.TGetInfoValue _elem281;
                    _elem281 = new global::HiveClient.Sql.ThriftApi.TCLService.TTypes.TGetInfoValue();
    ...
    public async global::System.Threading.Tasks.Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
    {
      ...
      try
      {
        ...
        if((GetInfos != null) && __isset.getInfos)
        {
          ...
          foreach (global::HiveClient.Sql.ThriftApi.TCLService.TTypes.TGetInfoValue _iter285 in GetInfos)
          {
