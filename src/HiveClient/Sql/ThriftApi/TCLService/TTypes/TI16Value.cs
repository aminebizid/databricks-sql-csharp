...
namespace HiveClient.Sql.ThriftApi.TCLService.TTypes
{
  ...
  public partial class TI16Value : TBase
  {
    ...
    {
      if (that is not TI16Value other) return false;
    ...
    {
      var tmp81 = new StringBuilder("TI16Value(");
      int tmp82 = 0;
      if(__isset.@value)
      {
        if(0 < tmp82++) { tmp81.Append(", "); }
        tmp81.Append("Value: ");
        Value.ToString(tmp81);
      }
      tmp81.Append(')');
