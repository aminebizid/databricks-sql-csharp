...
namespace HiveClient.Sql.ThriftApi.TCLService.TTypes
{
  ...
  public partial class TGetCrossReferenceResp : TBase
  {
    ...
    public async global::System.Threading.Tasks.Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
    {
      ...
      try
      {
        var tmp405 = new TStruct("TGetCrossReferenceResp");
    ...
    {
      if (that is not TGetCrossReferenceResp other) return false;
    ...
    {
      var tmp407 = new StringBuilder("TGetCrossReferenceResp(");
      int tmp408 = 0;
      if((Status != null) && __isset.status)
      {
        if(0 < tmp408++) { tmp407.Append(", "); }
        tmp407.Append("Status: ");
        Status.ToString(tmp407);
      }
      if((OperationHandle != null) && __isset.operationHandle)
      {
        if(0 < tmp408++) { tmp407.Append(", "); }
        tmp407.Append("OperationHandle: ");
        OperationHandle.ToString(tmp407);
      }
      if((DirectResults != null) && __isset.directResults)
      {
        if(0 < tmp408++) { tmp407.Append(", "); }
        tmp407.Append("DirectResults: ");
        DirectResults.ToString(tmp407);
      }
      tmp407.Append(')');
