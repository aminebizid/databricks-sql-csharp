...
namespace HiveClient.Sql.ThriftApi.TCLService.TTypes
{
  ...
  public partial class TGetTypeInfoResp : TBase
  {
    ...
    public async global::System.Threading.Tasks.Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
    {
      ...
      try
      {
        var tmp337 = new TStruct("TGetTypeInfoResp");
    ...
    {
      if (that is not TGetTypeInfoResp other) return false;
    ...
    {
      var tmp339 = new StringBuilder("TGetTypeInfoResp(");
      int tmp340 = 0;
      if((Status != null) && __isset.status)
      {
        if(0 < tmp340++) { tmp339.Append(", "); }
        tmp339.Append("Status: ");
        Status.ToString(tmp339);
      }
      if((OperationHandle != null) && __isset.operationHandle)
      {
        if(0 < tmp340++) { tmp339.Append(", "); }
        tmp339.Append("OperationHandle: ");
        OperationHandle.ToString(tmp339);
      }
      if((DirectResults != null) && __isset.directResults)
      {
        if(0 < tmp340++) { tmp339.Append(", "); }
        tmp339.Append("DirectResults: ");
        DirectResults.ToString(tmp339);
      }
      tmp339.Append(')');
