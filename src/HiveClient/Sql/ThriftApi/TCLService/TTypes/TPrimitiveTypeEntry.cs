...
namespace HiveClient.Sql.ThriftApi.TCLService.TTypes
{
  ...
  {
    private global::HiveClient.Sql.ThriftApi.TCLService.TTypes.TTypeId _type;
    private global::HiveClient.Sql.ThriftApi.TCLService.TTypes.TTypeQualifiers? _typeQualifiers;

    /// <summary>
    /// 
    /// <seealso cref="TTypeId"/>
    /// </summary>
    public global::HiveClient.Sql.ThriftApi.TCLService.TTypes.TTypeId Type
    {
      get
      {
        return _type;
    ...
    public global::HiveClient.Sql.ThriftApi.TCLService.TTypes.TTypeQualifiers? TypeQualifiers
    {
      get
      {
        ...
        while (true)
        {
          ...
          switch (field.ID)
          {
            case 1:
              ...
              {
                Type = (global::HiveClient.Sql.ThriftApi.TCLService.TTypes.TTypeId)await iprot.ReadI32Async(cancellationToken);
              }
              else
              {
            ...
            case 2:
              ...
              {
                TypeQualifiers = new global::HiveClient.Sql.ThriftApi.TCLService.TTypes.TTypeQualifiers();
