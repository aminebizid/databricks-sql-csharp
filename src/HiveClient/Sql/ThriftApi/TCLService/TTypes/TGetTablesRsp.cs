...
namespace HiveClient.Sql.ThriftApi.TCLService.TTypes
{
  ...
  public partial class TGetTablesRsp : TBase
  {
    ...
    public async global::System.Threading.Tasks.Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
    {
      ...
      try
      {
        var tmp365 = new TStruct("TGetTablesRsp");
    ...
    {
      if (that is not TGetTablesRsp other) return false;
    ...
    {
      var tmp367 = new StringBuilder("TGetTablesRsp(");
      int tmp368 = 0;
      if((Status != null) && __isset.status)
      {
        if(0 < tmp368++) { tmp367.Append(", "); }
        tmp367.Append("Status: ");
        Status.ToString(tmp367);
      }
      if((OperationHandle != null) && __isset.operationHandle)
      {
        if(0 < tmp368++) { tmp367.Append(", "); }
        tmp367.Append("OperationHandle: ");
        OperationHandle.ToString(tmp367);
      }
      if((DirectResults != null) && __isset.directResults)
      {
        if(0 < tmp368++) { tmp367.Append(", "); }
        tmp367.Append("DirectResults: ");
        DirectResults.ToString(tmp367);
      }
      tmp367.Append(')');
