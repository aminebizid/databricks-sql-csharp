...
namespace HiveClient.Sql.ThriftApi.TCLService.TTypes
{
  ...
  public partial class TGetSchemasResp : TBase
  {
    ...
    public async global::System.Threading.Tasks.Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
    {
      ...
      try
      {
        var tmp353 = new TStruct("TGetSchemasResp");
    ...
    {
      if (that is not TGetSchemasResp other) return false;
    ...
    {
      var tmp355 = new StringBuilder("TGetSchemasResp(");
      int tmp356 = 0;
      if((Status != null) && __isset.status)
      {
      ...
      {
        if(0 < tmp356++) { tmp355.Append(", "); }
        tmp355.Append("OperationHandle: ");
        OperationHandle.ToString(tmp355);
      }
      if((DirectResults != null) && __isset.directResults)
      {
        if(0 < tmp356++) { tmp355.Append(", "); }
        tmp355.Append("DirectResults: ");
        DirectResults.ToString(tmp355);
      }
      tmp355.Append(')');
