...
namespace HiveClient.Sql.ThriftApi.TCLService.TTypes
{
  ...
  public partial class TGetInfoResp : TBase
  {
    ...
    private global::HiveClient.Sql.ThriftApi.TCLService.TTypes.TGetInfoValue? _infoValue;
    ...
    public global::HiveClient.Sql.ThriftApi.TCLService.TTypes.TGetInfoValue? InfoValue
    {
      get
      {
        return _infoValue;
        ...
        while (true)
        {
          ...
          switch (field.ID)
          {
            ...
            case 2:
              if (field.Type == TType.Struct)
              {
                InfoValue = new global::HiveClient.Sql.ThriftApi.TCLService.TTypes.TGetInfoValue();
    ...
    public async global::System.Threading.Tasks.Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
    {
      ...
      try
      {
        var tmp304 = new TStruct("TGetInfoResp");
        ...
        if((InfoValue != null) && __isset.infoValue)
        {
          tmp305.Name = "infoValue";
          tmp305.Type = TType.Struct;
          tmp305.ID = 2;
          await oprot.WriteFieldBeginAsync(tmp305, cancellationToken);
    ...
    {
      if (that is not TGetInfoResp other) return false;
      if (ReferenceEquals(this, other)) return true;
      return ((__isset.status == other.__isset.status) && ((!__isset.status) || (global::System.Object.Equals(Status, other.Status))))
        && ((__isset.infoValue == other.__isset.infoValue) && ((!__isset.infoValue) || (global::System.Object.Equals(InfoValue, other.InfoValue))));
    }
    ...
    {
      var tmp306 = new StringBuilder("TGetInfoResp(");
      int tmp307 = 0;
      if((Status != null) && __isset.status)
      {
        if(0 < tmp307++) { tmp306.Append(", "); }
        tmp306.Append("Status: ");
        Status.ToString(tmp306);
      }
      if((InfoValue != null) && __isset.infoValue)
      {
        if(0 < tmp307++) { tmp306.Append(", "); }
        tmp306.Append("InfoValue: ");
        InfoValue.ToString(tmp306);
      }
      tmp306.Append(')');
