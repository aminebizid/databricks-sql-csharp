...
namespace HiveClient.Sql.ThriftApi.TCLService.TTypes
{
  ...
  public partial class TGetPrimaryKeysResp : TBase
  {
    ...
    public async global::System.Threading.Tasks.Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
    {
      ...
      try
      {
        var tmp397 = new TStruct("TGetPrimaryKeysResp");
    ...
    {
      if (that is not TGetPrimaryKeysResp other) return false;
    ...
    {
      var tmp399 = new StringBuilder("TGetPrimaryKeysResp(");
      int tmp400 = 0;
      if((Status != null) && __isset.status)
      {
        if(0 < tmp400++) { tmp399.Append(", "); }
        tmp399.Append("Status: ");
        Status.ToString(tmp399);
      }
      if((OperationHandle != null) && __isset.operationHandle)
      {
        if(0 < tmp400++) { tmp399.Append(", "); }
        tmp399.Append("OperationHandle: ");
        OperationHandle.ToString(tmp399);
      }
      if((DirectResults != null) && __isset.directResults)
      {
        if(0 < tmp400++) { tmp399.Append(", "); }
        tmp399.Append("DirectResults: ");
        DirectResults.ToString(tmp399);
      }
      tmp399.Append(')');
