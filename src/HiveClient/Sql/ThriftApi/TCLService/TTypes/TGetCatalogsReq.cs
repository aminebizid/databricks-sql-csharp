...
namespace HiveClient.Sql.ThriftApi.TCLService.TTypes
{
  ...
  public partial class TGetCatalogsReq : TBase
  {
    ...
    public async global::System.Threading.Tasks.Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
    {
      ...
      try
      {
        var tmp341 = new TStruct("TGetCatalogsReq");
    ...
    {
      if (that is not TGetCatalogsReq other) return false;
    ...
    {
      var tmp343 = new StringBuilder("TGetCatalogsReq(");
      int tmp344 = 0;
      if((SessionHandle != null) && __isset.sessionHandle)
      {
        if(0 < tmp344++) { tmp343.Append(", "); }
        tmp343.Append("SessionHandle: ");
        SessionHandle.ToString(tmp343);
      }
      if((GetDirectResults != null) && __isset.getDirectResults)
      {
        if(0 < tmp344++) { tmp343.Append(", "); }
        tmp343.Append("GetDirectResults: ");
        GetDirectResults.ToString(tmp343);
      }
      if(__isset.runAsync)
      {
        if(0 < tmp344++) { tmp343.Append(", "); }
        tmp343.Append("RunAsync: ");
        RunAsync.ToString(tmp343);
      }
      if((OperationId != null) && __isset.operationId)
      {
        if(0 < tmp344++) { tmp343.Append(", "); }
        tmp343.Append("OperationId: ");
        OperationId.ToString(tmp343);
      }
      if((SessionConf != null) && __isset.sessionConf)
      {
        if(0 < tmp344++) { tmp343.Append(", "); }
        tmp343.Append("SessionConf: ");
        SessionConf.ToString(tmp343);
      }
      tmp343.Append(')');
