...
namespace HiveClient.Sql.ThriftApi.TCLService.TTypes
{
  ...
  public partial class TGetTypeInfoReq : TBase
  {
    ...
    public async global::System.Threading.Tasks.Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
    {
      ...
      try
      {
        var tmp333 = new TStruct("TGetTypeInfoReq");
        ...
        if(__isset.runAsync)
        {
          tmp334.Name = "runAsync";
          tmp334.Type = TType.Bool;
          tmp334.ID = 1282;
          await oprot.WriteFieldBeginAsync(tmp334, cancellationToken);
    ...
    {
      if (that is not TGetTypeInfoReq other) return false;
    ...
    {
      var tmp335 = new StringBuilder("TGetTypeInfoReq(");
      int tmp336 = 0;
      if((SessionHandle != null) && __isset.sessionHandle)
      {
      ...
      {
        if(0 < tmp336++) { tmp335.Append(", "); }
        tmp335.Append("GetDirectResults: ");
        GetDirectResults.ToString(tmp335);
      }
      if(__isset.runAsync)
      {
        if(0 < tmp336++) { tmp335.Append(", "); }
        tmp335.Append("RunAsync: ");
        RunAsync.ToString(tmp335);
      }
      if((OperationId != null) && __isset.operationId)
      {
        if(0 < tmp336++) { tmp335.Append(", "); }
        tmp335.Append("OperationId: ");
        OperationId.ToString(tmp335);
      }
      if((SessionConf != null) && __isset.sessionConf)
      {
        if(0 < tmp336++) { tmp335.Append(", "); }
        tmp335.Append("SessionConf: ");
        SessionConf.ToString(tmp335);
      }
      tmp335.Append(')');
