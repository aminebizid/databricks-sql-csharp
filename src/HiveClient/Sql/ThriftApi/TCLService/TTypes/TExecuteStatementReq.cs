...
namespace HiveClient.Sql.ThriftApi.TCLService.TTypes
{
  ...
  public partial class TExecuteStatementReq : TBase
  {
    ...
    private global::HiveClient.Sql.ThriftApi.TCLService.TTypes.TSparkArrowTypes? _useArrowNativeTypes;
    ...
    public global::HiveClient.Sql.ThriftApi.TCLService.TTypes.TSparkArrowTypes? UseArrowNativeTypes
    {
      get
      {
        ...
        while (true)
        {
          ...
          switch (field.ID)
          {
            ...
            case 1286:
              if (field.Type == TType.Struct)
              {
                UseArrowNativeTypes = new global::HiveClient.Sql.ThriftApi.TCLService.TTypes.TSparkArrowTypes();
