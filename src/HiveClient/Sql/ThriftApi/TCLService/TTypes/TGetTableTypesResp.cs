...
namespace HiveClient.Sql.ThriftApi.TCLService.TTypes
{
  ...
  public partial class TGetTableTypesResp : TBase
  {
    ...
    public async global::System.Threading.Tasks.Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
    {
      ...
      try
      {
        var tmp373 = new TStruct("TGetTableTypesResp");
    ...
    {
      if (that is not TGetTableTypesResp other) return false;
    ...
    {
      var tmp375 = new StringBuilder("TGetTableTypesResp(");
      int tmp376 = 0;
      if((Status != null) && __isset.status)
      {
        if(0 < tmp376++) { tmp375.Append(", "); }
        tmp375.Append("Status: ");
        Status.ToString(tmp375);
      }
      if((OperationHandle != null) && __isset.operationHandle)
      {
        if(0 < tmp376++) { tmp375.Append(", "); }
        tmp375.Append("OperationHandle: ");
        OperationHandle.ToString(tmp375);
      }
      if((DirectResults != null) && __isset.directResults)
      {
        if(0 < tmp376++) { tmp375.Append(", "); }
        tmp375.Append("DirectResults: ");
        DirectResults.ToString(tmp375);
      }
      tmp375.Append(')');
