...
namespace HiveClient.Sql.ThriftApi.TCLService.TTypes
{
  ...
  public partial class TGetColumnsResp : TBase
  {
    ...
    public async global::System.Threading.Tasks.Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
    {
      ...
      try
      {
        var tmp381 = new TStruct("TGetColumnsResp");
    ...
    {
      if (that is not TGetColumnsResp other) return false;
    ...
    {
      var tmp383 = new StringBuilder("TGetColumnsResp(");
      int tmp384 = 0;
      if((Status != null) && __isset.status)
      {
        if(0 < tmp384++) { tmp383.Append(", "); }
        tmp383.Append("Status: ");
        Status.ToString(tmp383);
      }
      if((OperationHandle != null) && __isset.operationHandle)
      {
        if(0 < tmp384++) { tmp383.Append(", "); }
        tmp383.Append("OperationHandle: ");
        OperationHandle.ToString(tmp383);
      }
      if((DirectResults != null) && __isset.directResults)
      {
        if(0 < tmp384++) { tmp383.Append(", "); }
        tmp383.Append("DirectResults: ");
        DirectResults.ToString(tmp383);
      }
      tmp383.Append(')');
