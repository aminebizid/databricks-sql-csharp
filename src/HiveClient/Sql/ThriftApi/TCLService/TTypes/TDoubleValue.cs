...
namespace HiveClient.Sql.ThriftApi.TCLService.TTypes
{
  ...
  public partial class TDoubleValue : TBase
  {
    ...
    {
      if (that is not TDoubleValue other) return false;
    ...
    {
      var tmp93 = new StringBuilder("TDoubleValue(");
      int tmp94 = 0;
      if(__isset.@value)
      {
        if(0 < tmp94++) { tmp93.Append(", "); }
        tmp93.Append("Value: ");
        Value.ToString(tmp93);
      }
      tmp93.Append(')');
