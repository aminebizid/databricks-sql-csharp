...
namespace DataBricks.Sql.ThriftApi.TCLService.TTypes
{
  ...
  public partial class TCloseOperationReq : TBase
  {
    ...
    public async global::System.Threading.Tasks.Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
    {
      ...
      try
      {
        var tmp425 = new TStruct("TCloseOperationReq");
    ...
    {
      if (that is not TCloseOperationReq other) return false;
    ...
    {
      var tmp427 = new StringBuilder("TCloseOperationReq(");
      int tmp428 = 0;
      if((OperationHandle != null) && __isset.operationHandle)
      {
        if(0 < tmp428++) { tmp427.Append(", "); }
        tmp427.Append("OperationHandle: ");
        OperationHandle.ToString(tmp427);
      }
      tmp427.Append(')');
