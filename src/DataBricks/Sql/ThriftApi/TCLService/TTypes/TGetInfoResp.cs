...
namespace DataBricks.Sql.ThriftApi.TCLService.TTypes
{
  ...
  public partial class TGetInfoResp : TBase
  {
    ...
    private global::DataBricks.Sql.ThriftApi.TCLService.TTypes.TGetInfoValue? _infoValue;
    ...
    public global::DataBricks.Sql.ThriftApi.TCLService.TTypes.TGetInfoValue? InfoValue
    {
      get
      {
        return _infoValue;
        ...
        while (true)
        {
          ...
          switch (field.ID)
          {
            ...
            case 2:
              if (field.Type == TType.Struct)
              {
                InfoValue = new global::DataBricks.Sql.ThriftApi.TCLService.TTypes.TGetInfoValue();
