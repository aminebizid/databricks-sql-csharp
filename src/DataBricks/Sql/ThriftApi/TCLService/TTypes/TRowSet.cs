...
namespace DataBricks.Sql.ThriftApi.TCLService.TTypes
{
  ...
  public partial class TRowSet : TBase
  {
    ...
    private List<global::DataBricks.Sql.ThriftApi.TCLService.TTypes.TRow>? _rows;
    private List<global::DataBricks.Sql.ThriftApi.TCLService.TTypes.TColumn>? _columns;
    private byte[]? _binaryColumns;
    private int _columnCount;
    private List<global::DataBricks.Sql.ThriftApi.TCLService.TTypes.TSparkArrowBatch>? _arrowBatches;
    private List<global::DataBricks.Sql.ThriftApi.TCLService.TTypes.TSparkArrowResultLink>? _resultLinks;
    ...
    public List<global::DataBricks.Sql.ThriftApi.TCLService.TTypes.TRow>? Rows
    {
      get
      {
        return _rows;
    ...
    public List<global::DataBricks.Sql.ThriftApi.TCLService.TTypes.TColumn>? Columns
    {
      get
      {
        return _columns;
    ...
    public List<global::DataBricks.Sql.ThriftApi.TCLService.TTypes.TSparkArrowBatch>? ArrowBatches
    {
      get
      {
    ...
    public List<global::DataBricks.Sql.ThriftApi.TCLService.TTypes.TSparkArrowResultLink>? ResultLinks
    {
      get
      {
        return _resultLinks;
              ...
              {
                {
                  ...
                  Rows = new List<global::DataBricks.Sql.ThriftApi.TCLService.TTypes.TRow>(_list187.Count);
                  for(int _i188 = 0; _i188 < _list187.Count; ++_i188)
                  {
                    global::DataBricks.Sql.ThriftApi.TCLService.TTypes.TRow _elem189;
                    _elem189 = new global::DataBricks.Sql.ThriftApi.TCLService.TTypes.TRow();
              ...
              {
                {
                  ...
                  Columns = new List<global::DataBricks.Sql.ThriftApi.TCLService.TTypes.TColumn>(_list190.Count);
                  for(int _i191 = 0; _i191 < _list190.Count; ++_i191)
                  {
                    global::DataBricks.Sql.ThriftApi.TCLService.TTypes.TColumn _elem192;
                    _elem192 = new global::DataBricks.Sql.ThriftApi.TCLService.TTypes.TColumn();
              ...
              {
                {
                  ...
                  ArrowBatches = new List<global::DataBricks.Sql.ThriftApi.TCLService.TTypes.TSparkArrowBatch>(_list193.Count);
                  for(int _i194 = 0; _i194 < _list193.Count; ++_i194)
                  {
                    global::DataBricks.Sql.ThriftApi.TCLService.TTypes.TSparkArrowBatch _elem195;
                    _elem195 = new global::DataBricks.Sql.ThriftApi.TCLService.TTypes.TSparkArrowBatch();
              ...
              {
                {
                  ...
                  ResultLinks = new List<global::DataBricks.Sql.ThriftApi.TCLService.TTypes.TSparkArrowResultLink>(_list196.Count);
                  for(int _i197 = 0; _i197 < _list196.Count; ++_i197)
                  {
                    global::DataBricks.Sql.ThriftApi.TCLService.TTypes.TSparkArrowResultLink _elem198;
                    _elem198 = new global::DataBricks.Sql.ThriftApi.TCLService.TTypes.TSparkArrowResultLink();
    ...
    public async global::System.Threading.Tasks.Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
    {
      ...
      try
      {
        ...
        if((Rows != null) && __isset.rows)
        {
          ...
          foreach (global::DataBricks.Sql.ThriftApi.TCLService.TTypes.TRow _iter201 in Rows)
          {
        ...
        if((Columns != null) && __isset.columns)
        {
          ...
          foreach (global::DataBricks.Sql.ThriftApi.TCLService.TTypes.TColumn _iter202 in Columns)
          {
        ...
        if((ArrowBatches != null) && __isset.arrowBatches)
        {
          ...
          foreach (global::DataBricks.Sql.ThriftApi.TCLService.TTypes.TSparkArrowBatch _iter203 in ArrowBatches)
          {
        ...
        if((ResultLinks != null) && __isset.resultLinks)
        {
          ...
          foreach (global::DataBricks.Sql.ThriftApi.TCLService.TTypes.TSparkArrowResultLink _iter204 in ResultLinks)
          {
