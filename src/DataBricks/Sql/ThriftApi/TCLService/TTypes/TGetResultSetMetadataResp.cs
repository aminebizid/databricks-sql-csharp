...
namespace DataBricks.Sql.ThriftApi.TCLService.TTypes
{
  ...
  public partial class TGetResultSetMetadataResp : TBase
  {
    ...
    private global::DataBricks.Sql.ThriftApi.TCLService.TTypes.TTableSchema? _schema;
    ...
    public global::DataBricks.Sql.ThriftApi.TCLService.TTypes.TTableSchema? Schema
    {
      get
      {
        return _schema;
        ...
        while (true)
        {
          ...
          switch (field.ID)
          {
            ...
            case 2:
              if (field.Type == TType.Struct)
              {
                Schema = new global::DataBricks.Sql.ThriftApi.TCLService.TTypes.TTableSchema();
